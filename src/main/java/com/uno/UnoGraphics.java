...
public class UnoGraphics extends JPanel implements MouseListener, MouseMotionListener
{
    ...
    private boolean repaintHoverEnd = false;
    private boolean endScreen = false;
    private String hoveringEnd = "none";
...
//						game.playerList.get(0).sortHand(game.showTopCard().getColor(), game.showTopCard().getValue());
            ...
            else if(repaintHoverEnd)
            {
                ...
                else if (hoveringEnd.equals("rematch"))
                {
                    try {
        ...
        else
        {
            if(start)
            {
                ...
                g2.setColor(hoverStart.equals("cpu")?Color.red:Color.black);
                g2.drawRect(x(857),y(530), xs(150), ys(62));

                g2.setColor(hoverStart.equals("lan")?Color.red:Color.black);
                g2.drawRect(x(857), y(610), xs(150), ys(62));

                g2.setColor(hoverStart.equals("options")?Color.red:Color.black);
                g2.drawRect(x(857), y(690), xs(150), ys(62));

                g2.setColor(hoverStart.equals("exit")?Color.red:Color.black);
                g2.drawRect(x(872),y(799), xs(120), ys(52));
            ...
            else if(enterNames)
            {
                ...
                if(confirm)
                {
                    ...
                    g.setColor(Color.black);
                    g2.drawRect(x(790), y(375), xs(320), ys(365));

                    g2.drawRect(x(840), y(670), xs(50), ys(30));
                    g2.drawRect(x(1000), y(670), xs(60), ys(30));
                    g.setFont(new Font("Trebuchet", Font.PLAIN, font(25)));
                    ...
                    g.drawString("YES", x(1010), y(693));
                    g.drawString("NO", x(851), y(693));
                }
...
//					g.game.infiniteDraw = infiniteDraw;
    ...
    public void mouseMoved(MouseEvent e) {
        ...
        if(game.isOver()&& endScreen && !gameEndedBack && e.getX()>= x(500) && e.getX()<=x(1300) && e.getY()>=y(475) && e.getY()<=y(800))
        {
            //785), y(491), xs(310), ys(80));
            //(x(804), y(641
            if(e.getX()>= x(785) && e.getX()<=x(785+310) && e.getY()>=y(491) && e.getY()<=y(571))
            {
                hoveringEnd = "new";
                repaintHoverEnd = true;
                paintImmediately(x(500), y(475), x(1300)-x(500), y(800)-y(475));
            }
            else if(e.getX()>= x(804) && e.getX()<=x(804+275) && e.getY()>=y(650) && e.getY()<=y(730))
            {
                hoveringEnd = "rematch";
                repaintHoverEnd = true;
                paintImmediately(x(500), y(475), x(1300)-x(500), y(800)-y(475));
        ...
        {
            if(!hoveringEnd.equals("none") && game.isOver() && endScreen)
            {
                hoveringEnd = "none";
                if(!gameEndedBack)
                {
